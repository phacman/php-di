...
namespace DI\Zeal\ProxyManager\ProxyGenerator\Util;
...
class PublicScopeSimulator
{
    ...
    public static function getPublicAccessSimulationCode(
        ...
        return '$realInstanceReflection = ' . $originalClassReflection . ';' . "\n\n"
            ...
            . implode(', ', array_map(
                static function (string $parameterName) : string { return '$' . $parameterName; },
    ...
    private static function generateScopeReBind() : string
    {
        return <<<'PHP'
            ...
            $scopeObject = isset($backtrace[1]['object']) ? $backtrace[1]['object'] : new \DI\Zeal\ProxyManager\Stub\EmptyClassStub();
