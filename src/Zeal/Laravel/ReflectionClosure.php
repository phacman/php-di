...
class ReflectionClosure extends ReflectionFunction
{
                    ...
                    switch ($token[0]) {
                        ...
                        case '(':
                            ...
                            if ($context === 'new' || str_contains($id_name, '\\')) {
                                ...
                                } elseif ($id_start !== '\\' && ! in_array($id_start_ci, $class_keywords, true)) {
                                    if ($classes === null) {
                        ...
                        case T_DOUBLE_COLON:
                            if ($id_start !== '\\') {
                                ...
                                } elseif (! (PHP_MAJOR_VERSION >= 7 && in_array($id_start_ci, $builtin_types, true))) {
                                    if ($classes === null) {
                                        $classes = $this->getClasses();
                                    }
                                    if (isset($classes[$id_start_ci])) {
                        ...
                        default:
                            if ($id_start !== '\\' && ! defined($id_start)) {
                                ...
                                if (isset($constants[$id_start])) {
                                    ...
                                    if (in_array($id_start_ci, $class_keywords, true)) {
                                        if (! $inside_structure) {
                                            $isUsingScope = true;
                                        }
                                    } else {
    ...
    protected function getClosureNamespaceName() : string
    {
        ...
        if ($this->getName() !== '{closure}' && empty($ns) && null !== $this->getClosureScopeClass()) {
